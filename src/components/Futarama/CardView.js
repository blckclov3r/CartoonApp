...
export default function CardView({Name, Relatives, PicUrl,Status,Profession,Planet,Species,Age}) {
  ...
  return (
    ...
    <Card style={{ width: '18rem'}} className="h-100 shadow-sm">
       <Card.Img variant="top" src={PicUrl} className="img-fluid img-thumbnail" style={{height: "300px", width: "300px"}} onError={(img)=>{
